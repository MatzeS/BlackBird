...
class _$SimpleDevice implements Device {
  _$SimpleDevice();

  SimpleDevice implementation() => throw new Exception();
  SimpleDevice getRemote(Context context, String uuid) =>
      _$SimpleDeviceRmi.getRemote(context, uuid);
  SimpleDevice interface() => Blackbird().interfaceDevice(this);
...
class _$SimpleDeviceImplementation extends SimpleDevice {
  ...
  _$SimpleDeviceImplementation(int propertyField) : super(propertyField);
