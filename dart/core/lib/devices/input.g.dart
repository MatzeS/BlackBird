...
class _$BinaryInputInvoker {
  static dynamic invoke(Invocation invocation, BinaryInput target) {
    if (invocation.isGetter && #states == invocation.memberName) {
      return target.states;
    }
    if (invocation.isGetter && #isOn == invocation.memberName) {
      return target.isOn;
    }
    if (invocation.isGetter && #isOff == invocation.memberName) {
      return target.isOff;
    }
...
class _$DiscreteInputInvoker {
  static dynamic invoke(Invocation invocation, DiscreteInput target) {
    if (invocation.isGetter && #states == invocation.memberName) {
      return target.states;
    }
    if (invocation.isGetter && #state == invocation.memberName) {
...
class _$DiscreteInterruptInputInvoker {
  static dynamic invoke(Invocation invocation, DiscreteInterruptInput target) {
    ...
    if (invocation.isGetter && #stateChange == invocation.memberName) {
      return target.stateChange;
    }
    if (invocation.isGetter && #states == invocation.memberName) {
      return target.states;
    }
...
class _$BinaryInputProxy implements BinaryInput {
  ...
  _$BinaryInputProxy(this._handle) : super();
  ...
  dynamic get isOn async {
    Invocation invocation = Invocation.getter(#isOn);
  ...
  dynamic get isOff async {
    Invocation invocation = Invocation.getter(#isOff);
...
class _$DiscreteInputProxy implements DiscreteInput {
  ...
  InvocationHandlerFunction _handle;
  _$DiscreteInputProxy(this._handle) : super();
...
class _$DiscreteInterruptInputProxy implements DiscreteInterruptInput {
  ...
  InvocationHandlerFunction _handle;
  _$DiscreteInterruptInputProxy(this._handle) : super();
  ...
  Stream<int> get stateChange {
    Invocation invocation = Invocation.getter(#stateChange);
...
class _$BinaryInputRmi {
  static void _registerSerializers(Context context) {}
  static void _registerStubConstructors(Context context) {
    context.registerRemoteStubConstructor(
        'asset:blackbird/lib/devices/input.dart#BinaryInput', getRemote);
  }

  static BinaryInput getRemote(Context context, String uuid) {
    _registerSerializers(context);
    _registerStubConstructors(context);
    RmiProxyHandler handler = RmiProxyHandler(context, uuid);
    return _$BinaryInputProxy(handler.handle);
  }

  static Provision provideRemote(Context context, BinaryInput target) {
    _registerSerializers(context);
    _registerStubConstructors(context);
    return rmiProvideRemote(
        context, target, 'asset:blackbird/lib/devices/input.dart#BinaryInput');
  }
}

class _$DiscreteInputRmi {
  static void _registerSerializers(Context context) {}
  static void _registerStubConstructors(Context context) {
    context.registerRemoteStubConstructor(
        'asset:blackbird/lib/devices/input.dart#DiscreteInput', getRemote);
  }
  ...
  static DiscreteInput getRemote(Context context, String uuid) {
    ...
    _registerStubConstructors(context);
    RmiProxyHandler handler = RmiProxyHandler(context, uuid);
    return _$DiscreteInputProxy(handler.handle);
  }

  static Provision provideRemote(Context context, DiscreteInput target) {
    _registerSerializers(context);
    _registerStubConstructors(context);
    return rmiProvideRemote(context, target,
        'asset:blackbird/lib/devices/input.dart#DiscreteInput');
  }
}

class _$DiscreteInterruptInputRmi {
  static void _registerSerializers(Context context) {}
  static void _registerStubConstructors(Context context) {
    context.registerRemoteStubConstructor(
        'asset:blackbird/lib/devices/input.dart#DiscreteInterruptInput',
        getRemote);
  }
  ...
  static DiscreteInterruptInput getRemote(Context context, String uuid) {
    ...
    _registerStubConstructors(context);
    RmiProxyHandler handler = RmiProxyHandler(context, uuid);
    return _$DiscreteInterruptInputProxy(handler.handle);
  }

  static Provision provideRemote(
      Context context, DiscreteInterruptInput target) {
    _registerSerializers(context);
    _registerStubConstructors(context);
    return rmiProvideRemote(context, target,
        'asset:blackbird/lib/devices/input.dart#DiscreteInterruptInput');
