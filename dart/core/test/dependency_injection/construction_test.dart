...
main() {
  ...
  singleDependencyBuilder(DependencyBuilder b) {
    blackbird.helpers.dependencyBuilders.removeWhere((b) => true);
    blackbird.helpers.dependencyBuilders.add(b);
  }
  ...
  group('automatic construction', () {
    test('construction', () async {
      ...
      device.otherDevice = new EvenSimplerDevice();
      blackbird.addDependencyBuilder(
          new RuntimeDependencyBuilder(significantNumber));
      SimpleDevice implementation = await blackbird.interfaceDevice(device);
